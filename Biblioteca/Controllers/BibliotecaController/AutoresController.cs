...
namespace Biblioteca.Controllers.BibliotecaController
{
    public class AutoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AutorID,NombreAutor,Nacionalidad")] Autores autores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AutorID,NombreAutor,Nacionalidad")] Autores autores)
        {
            if (ModelState.IsValid)
            {
